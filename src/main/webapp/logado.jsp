    ...
    <div class="bodyFull">
        <nav class="navegacao">
            <div class="redes-sociais">
                ...
                <a href="https://www.instagram.com/miranda.of7/">Instagram</a>
        ...
        <div id="subTitulo"><p>Ache seu curso</p></div>
        <section class="cursos-especificos">
            <div>
                <button id="programcaoBotao" onclick="">Programação</button>
            ...
            <div>
                <button id="FinancasBotao" onclick="">Finanças e Investimentos</button>
            ...
            <div>
                <button id="NegóciosBotao" onclick="">Empreendedorismo e Negócios</button>
            ...
            <div>
                <button id="desenvolvimentoPessoalBotao" onclick="">Desenvolvimento Pessoal</button>
            ...
            <div>
                <button id="DesignMultimidiaBotao" onclick="">Design e Multimídia</button>
            ...
            <div>
                <button id="idiomasBotao" onclick="">Idiomas</button>
            ...
            <div>
                <button id="culinariaBotao" onclick="">Culinária</button>
